...
async def generate_reply(chat_id: Optional[str], message: str, email: str) -> tuple[str, str, Optional[str]]:
...
async def get_user_chats(email: str) -> List[Dict[str, Any]]:
...
async def delete_chat(chat_id: str, email: str) -> bool:
