...
const Index = () => {
  ...
  const mainFeatures = [
    ...
    },
    {
      ...
      description: "Upload your study materials, syllabus, and past papers for detailed and focused exam preparation with personalized AI guidance.",
    ...
    },
    {
      ...
      description: "Intelligent task management with AI-powered suggestions, priority detection, and smart organization to boost your productivity.",
    ...
    },
    {
      ...
      description: "Comprehensive dashboard showing your study patterns, quiz performance, session history, and personalized insights for continuous improvement.",
    ...
    },
    {
      icon: Brain,
      title: "Smart Memory",
      subtitle: "Your AI Memory Vault",
      description: "Store anything - files, passwords, notes, ideas. Just ask and retrieve instantly. Your personal virtual hard drive that understands natural language.",
      gradient: "from-cyan-500 via-teal-600 to-blue-500",
      iconBg: "from-cyan-500/20 to-blue-500/20",
      benefits: ["Instant Retrieval", "Secure Storage", "Voice-Activated Access"],
    },
  ];
